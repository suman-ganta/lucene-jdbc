 ...
 * <p/>
 * Note, using this index input requires calling the {@link #releaseBlobs(Connection)} when the transaction
...
public class FetchPerTransactionJdbcIndexInput extends JdbcBufferedIndexInput {
    ...
    protected FetchPerTransactionJdbcIndexInput(String resourceDescription) {
        super(resourceDescription);
    }

    public FetchPerTransactionJdbcIndexInput(String resourceDescription, int bufferSize) {
