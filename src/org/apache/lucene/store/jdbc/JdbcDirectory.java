 ...
 * {@link org.apache.lucene.store.jdbc.datasource.DataSourceUtils#getConnection(DataSource)} ), and close it
...
public class JdbcDirectory extends Directory implements MultiDeleteDirectory {
    ...
    /**
     * Delete all the file entries that are marked to be deleted, and they were marked
