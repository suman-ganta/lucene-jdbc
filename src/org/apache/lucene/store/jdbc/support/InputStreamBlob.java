 ...
 * <p>
 * Some jdbc drivers do not support the {@link java.sql.PreparedStatement#setBinaryStream(int, InputStream, int)}
 * method, but require using {@link java.sql.PreparedStatement#setBlob(int, Blob)}. For code that already has
