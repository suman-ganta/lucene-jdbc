...
public abstract class AbstractFileEntryHandler implements FileEntryHandler {
    ...
    public IndexInput openInput(String name) throws IOException {
        ...
        try {
            ...
            indexInput = (IndexInput) inputClass.getDeclaredConstructor(String.class).newInstance(name);
        } catch (Exception e) {
    ...
    public IndexOutput createOutput(String name) throws IOException {
        ...
        try {
            ...
            indexOutput = (IndexOutput) inputClass.getDeclaredConstructor(String.class).newInstance(name);
        } catch (Exception e) {
