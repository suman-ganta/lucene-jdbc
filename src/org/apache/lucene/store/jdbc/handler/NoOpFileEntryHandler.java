...
public class NoOpFileEntryHandler implements FileEntryHandler {
    ...
    private static class NoOpIndexInput extends IndexInput {
         ...
         */
        protected NoOpIndexInput(String resourceDescription) {
    ...
    private static class NoOpIndexOutput extends IndexOutput {
         ...
         * @param resourceDescription
         */
        protected NoOpIndexOutput(String resourceDescription) {
            super(resourceDescription);
        }
    ...
    private static IndexInput indexInput = new NoOpIndexInput("NoOpIndexInput");

    private static IndexOutput indexOutput = new NoOpIndexOutput("NoOpIndexOutput");
