 ...
 * {@link DataSourceUtils#commitConnectionIfPossible(Connection)} and
 * {@link DataSourceUtils#rollbackConnectionIfPossible(Connection)} will only call commit/rollback
...
public class TransactionAwareDataSourceProxy implements DataSource {
     ...
     * <p/>
     * Consider using {@link DataSourceUtils#getConnection(DataSource)} and
     * {@link DataSourceUtils#releaseConnection(Connection)} for simpler usage.
     */
