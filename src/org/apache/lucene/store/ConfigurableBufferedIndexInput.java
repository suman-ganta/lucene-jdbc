...
public abstract class ConfigurableBufferedIndexInput extends IndexInput implements RandomAccessInput {
    ...
    public ConfigurableBufferedIndexInput(String resourceDesc) {
        this(resourceDesc, BUFFER_SIZE);
    }

    public ConfigurableBufferedIndexInput(String resourceDesc, IOContext context) {
        this(resourceDesc, bufferSize(context));
    }

    /** Inits BufferedIndexInput with a specific bufferSize */
    public ConfigurableBufferedIndexInput(String resourceDesc, int bufferSize) {
        super(resourceDesc);
    ...
    @Override
    public ConfigurableBufferedIndexInput clone() {
