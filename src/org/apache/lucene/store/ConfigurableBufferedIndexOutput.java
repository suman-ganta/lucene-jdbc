...
public abstract class ConfigurableBufferedIndexOutput extends IndexOutput {
     ...
     */
    protected ConfigurableBufferedIndexOutput(String resourceDescription) {
    ...
    public long getChecksum() throws IOException {
        if (crc == null) {
            throw new IllegalStateException("internal ConfigurableBufferedIndexOutput created with checksum disabled");
        } else {
            return crc.getValue();
        }
    }
